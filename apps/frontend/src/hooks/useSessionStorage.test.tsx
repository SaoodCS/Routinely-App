...
const STORAGE_KEY = 'test-session-storage';
...
function StorageConsumer({ index }: { index: number }): ReactElement {
   const [value, setValue] = useSessionStorage(STORAGE_KEY, 'initial');
   return (
      <div>
...
describe('useSessionStorage', () => {
   ...
   it('persists updates and synchronizes consumers', () => {
      ...
      expect(window.sessionStorage.getItem(STORAGE_KEY)).toBe(JSON.stringify('updated'));
