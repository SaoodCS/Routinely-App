...
export default function ShoppingListEmptyPlaceholder(): React.JSX.Element {
   ...
   return (
      ...
      >
         ...
         >
            <ShoppingCartOutlined fontSize="large" sx={{ color: 'grey.500' }} />
            <Box>
               <Typography variant={'h6'} color="textSecondary">
                  {'No Items.'}
               </Typography>
               <Typography variant={'caption'} color={'textSecondary'}>
                  {'Create an item below to get started.'}
               </Typography>
            </Box>
         </Stack>
      </Stack>
